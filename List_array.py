...
class List:
    ...
    def find(self, key):
        ...
        if index != -1:
            # If key is found, then make a copy of the value at that index position.
    ...
    def index(self, key):
        ...
        """
        # Your code here
        # Finds the index position of the key using linear search
    ...
    def insert(self, i, value):
        ...
        list_len = len(self._values)
        if i < 0:
            # If i is negative, adjust it to be within the valid range
            i = list_len + i + 1

        # Add the data element at position i within the list
        if i >= list_len:
            # If i is beyond the end of the list, append the value
            self._values.append(val)
        else:
        ...
        # val = deepcopy(value)
        # # Add the data element at position i within the list
        # if i not in range(-len(self._values), len(self._values)):
        #     if (i < -len(self._values)):
        #         self._values.insert(0, val)  # Prepend to the list
        #     else:
        #         self._values.append(val)  # Append to the list
        # else:
        #     self._values[i] = val  # Insert at the specified index position
    ...
    def max(self):
        ...
        # Initialize value to first element of list
    ...
    def remove(self, key):
        ...
        if index != -1:
            # Retrieve the value before removing it
